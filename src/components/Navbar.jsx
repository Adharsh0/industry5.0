  ...
  <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
    <div className="nav-content">
      ...
      <div className="nav-links">
        ...
        <button className="nav-link-btn" onClick={() => handleSectionClick('speakers')}>Speakers</button>
    ...
    <div className={`mobile-menu ${menuOpen ? 'open' : ''}`}>
      <div className="mobile-menu-content">
        ...
        <button className="mobile-link-btn" onClick={() => handleSectionClick('speakers')}>Speakers</button>
